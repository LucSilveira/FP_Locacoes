...
public class MainActivityListAlugar extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_list_alugar);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        recyclerList = findViewById(R.id.recyclerAluga);
        dao = new TranspDao(this);
        carregarListaRecyclerAlg();

        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent inte = new Intent(MainActivityListAlugar.this, MainActivityAluga.class);
                startActivity(inte);
            }
        });
    ...
    private void carregarListaRecyclerAlg(){
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.main_activity_list_alugar, menu);
        return true;
    }
