    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cadastro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(email.getText().length() == 0 && senha.getText().length() >= 8){
                    Toast.makeText(getApplicationContext(), "Insira o email!", Toast.LENGTH_LONG).show();
                }else if(senha.getText().length() == 0 && email.getText().length() >= 10){
                    Toast.makeText(getApplicationContext(), "insira uma senha!", Toast.LENGTH_LONG).show();
                }else if(senha.getText().length() < 8 && email.getText().length() >= 10) {
                    Toast.makeText(getApplicationContext(), "insira uma senha com minimo de 8 carcteres!", Toast.LENGTH_LONG).show();
